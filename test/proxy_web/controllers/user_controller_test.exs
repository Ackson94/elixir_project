defmodule ProxyWeb.UserControllerTest do
  use ProxyWeb.ConnCase

  alias Proxy.Accounts

  @create_attrs %{bank_password: "some bank_password", bank_username: "some bank_username", password: "some password", username: "some username"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated bank_password"
    end
